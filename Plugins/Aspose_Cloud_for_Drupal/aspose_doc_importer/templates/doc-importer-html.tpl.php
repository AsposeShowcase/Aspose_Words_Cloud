...
<input type="button" value="Aspose DOC Importer" onclick="load_uploader();" id="edit-btn-select-pdf" class="form-submit" />
...
<div id="aspose_pdf_popup_container">
    ...
    <div id="upload-new">
        <fieldset id="pdf-reader-form" class="pdf-reader-form">
            ...
            <input class="form-submit" type="button" data-submit-to="<?php echo $base_url . '/ajax/UploadDocToCloud'; ?>" id="submit_btn" value="Extract DOC Contents" />
        </fieldset>
    </div>
    ...
    <div id="uploaded-files">
        <div style="float: right;">
            <input type="button" class="form-submit" data-submit-to="<?php echo $base_url . '/ajax/UploadDocToCloud'; ?>" id="insert_aspose_pdf_content" value="Select File"/>
        </div>
        <div id="cloud_files" style="width: 100%;float: left;">
            <?php
            // Get files list from cloud
            $result = aspose_doc_importer_cloud_files();
            echo $result;
            ?>
        </div>
    </div>
