 ...
 */
AsposeApp::$appSID = get_option('aspose_import_export_app_sid');
AsposeApp::$appKey = get_option('aspose_import_export_app_key');
...
$result = $func->convertLocalFile($file_name,'','doc');

$result = str_replace('.html','.doc',$file_name);
