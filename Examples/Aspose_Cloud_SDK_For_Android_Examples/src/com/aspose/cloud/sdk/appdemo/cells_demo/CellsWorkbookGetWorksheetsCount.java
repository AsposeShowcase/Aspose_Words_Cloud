...
public class CellsWorkbookGetWorksheetsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_getworksheetscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookGetWorksheetsCount.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.getWorksheetsCount();
					if (response > 0) {
						result.append("No of Worksheets = " + response);
					} else {
						result.append("No Worksheet Found");
					}
				}
			}
		});
