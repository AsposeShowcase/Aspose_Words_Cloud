...
public class CellsWorkbookRemoveWorksheet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_removeworksheet);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookRemoveWorksheet.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.removeWorksheet(worksheetName);
					if (response) {
						result.append("Given Worksheet is being removed");
					} else
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_removeworksheet_arg1);
