...
public class CellsWorkbookUnprotectWorkbook extends Activity {
	private EditText constructor_arg1;
	private EditText function_arg1;
	private TextView result;
	private Button btnSubmit;
	protected String password;
	protected boolean resposne;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_unprotectworkbook);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookUnprotectWorkbook.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					resposne = obj.unprotectWorkbook(password);
					if (resposne) {
						result.append("Workbook is unprotected");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_unprotectworkbook_arg1);
