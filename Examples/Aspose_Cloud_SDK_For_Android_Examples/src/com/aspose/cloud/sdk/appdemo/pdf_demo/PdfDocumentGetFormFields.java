...
public class PdfDocumentGetFormFields extends Activity {
	private EditText constructor_arg1;
	private TextView result;
	private Button btnSubmit;
	protected List<FormField> response;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_document_getformfields);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.getFormFields();
					if (response == null) {
						Toast.makeText(PdfDocumentGetFormFields.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("Oops.. Something went wrong");
					} else {
						result.append("\n List: \n");
						for (FormField item : response) {
