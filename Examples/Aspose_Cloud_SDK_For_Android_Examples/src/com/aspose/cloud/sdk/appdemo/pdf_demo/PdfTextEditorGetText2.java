...
public class PdfTextEditorGetText2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_texteditor_gettext2);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					TextEditor obj = new TextEditor(constructor_arg1.getText()
							.toString());
					response = obj.getText(pageNumber);
					if (response == null) {
						Toast.makeText(PdfTextEditorGetText2.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_texteditor_gettext2_arg1);
