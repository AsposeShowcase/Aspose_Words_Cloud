...
public class PdfDocumentGetDocumentProperties extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_document_getdocumentproperties);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfDocumentGetDocumentProperties.this);
					...
					if (response == null) {
						Toast.makeText(PdfDocumentGetDocumentProperties.this,
