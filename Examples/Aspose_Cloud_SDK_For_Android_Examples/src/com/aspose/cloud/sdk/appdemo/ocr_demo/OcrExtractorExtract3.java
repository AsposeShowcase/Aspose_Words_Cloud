...
public class OcrExtractorExtract3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ocr_extractor_extract3);
		init();
		...
		function_arg2
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(OcrExtractorExtract3.this,
		...
		btnBrowse.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				startActivityForResult(new Intent(OcrExtractorExtract3.this,
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							OcrExtractorExtract3.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					localFile = function_arg1.getText().toString();
					Extractor obj = new Extractor();
					response = obj.extractText(localFile, language,
	...
	private void init() {
		function_arg1 = (EditText) findViewById(R.id.ocr_extractor_extract3_arg1);
		function_arg2 = (Spinner) findViewById(R.id.ocr_extractor_extract3_arg2);
		function_arg2.setAdapter(new ArrayAdapter<LanguageName>(this,
				android.R.layout.simple_list_item_1, LanguageName.values()));
		function_arg3 = (CheckBox) findViewById(R.id.ocr_extractor_extract3_arg3);
		result = (TextView) findViewById(R.id.ocr_extractor_extract3_result);
