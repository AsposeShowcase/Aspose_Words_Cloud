...
import com.aspose.cloud.sdk.cells.DocumentProperty;
import com.aspose.cloud.sdk.cells.Workbook;
import com.aspose.cloud.sdk.common.Product;
import com.aspose.cloud.sdk.common.AsposeApp;

public class CellsWorkbookGetProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_getproperty);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					Workbook obj = new Workbook("rubyTest.xlsx");
					response = obj.getProperty(propertyName);
					if (response == null) {
						Toast.makeText(CellsWorkbookGetProperty.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Property Found");
					} else {
						result.append(" \n " + response.getName() + " - "
								+ response.getValue());
					}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_getproperty_arg1);
