...
public class CellsWorksheetGetChartsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getchartscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetChartsCount.this);
					...
					response = obj.getChartsCount();
					if (response > 0) {
						result.append("Total Number oF Charts = " + response);
					} else {
