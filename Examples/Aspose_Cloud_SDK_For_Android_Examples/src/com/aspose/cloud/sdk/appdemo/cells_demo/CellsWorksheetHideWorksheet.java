...
public class CellsWorksheetHideWorksheet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_hideworksheet);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetHideWorksheet.this);
					...
					response = obj.hideWorksheet();
					if (response) {
						result.append("Specified Worksheet is hide now");
					} else {
