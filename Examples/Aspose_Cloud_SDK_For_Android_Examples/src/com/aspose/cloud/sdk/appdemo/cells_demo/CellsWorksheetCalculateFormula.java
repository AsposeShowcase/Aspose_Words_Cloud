...
public class CellsWorksheetCalculateFormula extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_calculateformula);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetCalculateFormula.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					formula = function_arg1.getText().toString();
					Worksheet obj = new Worksheet(constructor_arg1.getText()
							.toString(), constructor_arg2.getText().toString());
					response = obj.calculateFormula(formula);
					if (response == null) {
						Toast.makeText(CellsWorksheetCalculateFormula.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_calculateformula_arg1);
