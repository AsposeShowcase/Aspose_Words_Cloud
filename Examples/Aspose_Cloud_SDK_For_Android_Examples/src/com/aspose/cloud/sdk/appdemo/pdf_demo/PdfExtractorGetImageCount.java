...
public class PdfExtractorGetImageCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_extractor_getimagecount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfExtractorGetImageCount.this);
					...
					Extractor obj = new Extractor(constructor_arg1.getText()
							.toString());
					response = obj.getImageCount(pageNumber);
					if (response > 0) {
						result.append("Numbers OF Images = " + response);
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_extractor_getimagecount_arg1);
