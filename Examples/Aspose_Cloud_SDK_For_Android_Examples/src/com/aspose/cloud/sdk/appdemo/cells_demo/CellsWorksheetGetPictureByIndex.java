...
public class CellsWorksheetGetPictureByIndex extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getpicturebyindex);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetPictureByIndex.this);
					...
					response = obj.getPictureByIndex(index);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetPictureByIndex.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Picture Found");
					} else {
						result.append("Picture Name - " + response.getName());
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getpicturebyindex_arg1);
