...
public class SlidesDocumentGetDocumentProperties extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slides_document_getdocumentproperties);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							SlidesDocumentGetDocumentProperties.this);
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.getDocumentProperties();
					if (response == null) {
						Toast.makeText(
								SlidesDocumentGetDocumentProperties.this,
