...
import com.aspose.cloud.sdk.cells.AutoShape;
import com.aspose.cloud.sdk.cells.Worksheet;
import com.aspose.cloud.sdk.common.Product;
import com.aspose.cloud.sdk.common.AsposeApp;

public class CellsWorksheetGetAutoShapeByIndex extends Activity {
	private EditText constructor_arg1, constructor_arg2;
	private EditText function_arg1;
	private TextView result;
	private Button btnSubmit;
	protected int index;
	protected AutoShape response;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		BasicConfigurator.configure();
		super.onCreate(savedInstanceState);
		setContentView(R.layout.cells_worksheet_getautoshapebyindex);
		init();
			...
			public void onClick(View arg0) {
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetAutoShapeByIndex.this);
					...
					response = obj.getAutoShapeByIndex(index);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetAutoShapeByIndex.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getautoshapebyindex_arg1);
