...
public class CellsTextEditorFindText extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_texteditor_findtext);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsTextEditorFindText.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					text = function_arg1.getText().toString();
					TextEditor obj = new TextEditor(constructor_arg1.getText()
							.toString());
					try {
						response = obj.findText(text);
						if (response == null) {
							Toast.makeText(CellsTextEditorFindText.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_texteditor_findtext_arg1);
