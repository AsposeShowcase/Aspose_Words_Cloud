...
public class PdfAnnotationEditorGetAnnotationsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_getannotationcount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorGetAnnotationsCount.this);
					...
					try {
						response = obj.getAnnotationsCount(pageNumber);
						if (response > 0) {
							result.append("No. Of Annotations = " + response);
						} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_annotationeditor_getannotationcount_arg1);
