...
public class CellsWorksheetGetCellsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcellscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetCellsCount.this);
					...
					response = obj.getCellsCount(offset, count);
					if (response > 0) {
						result.append("Numbers of Cells = " + response);
					} else {
						result.append("No Cell Found");
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getcellscount_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_getcellscount_arg2);
