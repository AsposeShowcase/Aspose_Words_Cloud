...
public class WordDocumentSetProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_document_setproperty);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.setProperty(propertyName, propertyValue);
					if (response) {
						result.append("New Property Value set Successfully");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.words_document_setproperty_arg1);
		function_arg2 = (EditText) findViewById(R.id.words_document_setproperty_arg2);
