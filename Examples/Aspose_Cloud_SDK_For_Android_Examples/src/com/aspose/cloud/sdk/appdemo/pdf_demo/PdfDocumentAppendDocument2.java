...
public class PdfDocumentAppendDocument2 extends Activity {
	private EditText constructor_arg1;
	private EditText function_arg1, function_arg2, function_arg3,
			function_arg4;
	private TextView result;
	private Button btnSubmit;
	protected String basePdf;
	protected String newPdf;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_document_appenddocument2);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfDocumentAppendDocument2.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					basePdf = function_arg1.getText().toString();
					newPdf = function_arg2.getText().toString();
					startPage = Integer.parseInt(function_arg3.getText()
							.toString());
					endPage = Integer.parseInt(function_arg4.getText()
							.toString());
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.appendDocument(basePdf, newPdf, startPage,
							endPage);
					if (response) {
						result.append("Files Appended Successfully");
					} else {
	...
	private void init() {
		...
		function_arg3 = (EditText) findViewById(R.id.pdf_document_appenddocument2_arg3);
		function_arg4 = (EditText) findViewById(R.id.pdf_document_appenddocument2_arg4);
