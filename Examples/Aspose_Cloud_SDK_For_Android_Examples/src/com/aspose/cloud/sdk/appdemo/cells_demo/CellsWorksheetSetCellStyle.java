...
public class CellsWorksheetSetCellStyle extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_setcellstyle);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetSetCellStyle.this);
					...
					response = obj.setCellStyle(cellName, style);
					if (response) {
						result.append(" \n Style is set in background file");
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_setcellstyle_arg1);
