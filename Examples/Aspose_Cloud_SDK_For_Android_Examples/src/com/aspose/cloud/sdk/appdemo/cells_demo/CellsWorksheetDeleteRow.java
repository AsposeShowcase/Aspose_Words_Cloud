...
public class CellsWorksheetDeleteRow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_deleterow);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					response = obj.deleteRow(rowIndex);
					if (response) {
						result.append("Row deleted Successfully.");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_deleterow_arg1);
