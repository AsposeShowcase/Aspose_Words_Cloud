...
public class CellsWorkbookAddWorksheet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_addworksheet);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookAddWorksheet.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.addWorksheet(worksheetName);
					if (response) {
						result.append("Worksheet is added Successfully");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_addworksheet_arg1);
