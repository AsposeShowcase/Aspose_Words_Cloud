...
public class CellsWorkbookGetDefaultStyle extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_getdefaultstyle);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookGetDefaultStyle.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.getDefaultStyle();
					if (response == null) {
						Toast.makeText(CellsWorkbookGetDefaultStyle.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
					} else {
						result.append(" \n Style Name-" + response.getName());
					}
				}
			}
		});
