...
public class WordMailMergeExecuteTemplate extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_mailmerge_executetemplate);
		init();
		function_arg3
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(WordMailMergeExecuteTemplate.this,
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							WordMailMergeExecuteTemplate.this);
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.words_mailmerge_executetemplate_arg1);
		function_arg2 = (EditText) findViewById(R.id.words_mailmerge_executetemplate_arg2);
		function_arg4 = (EditText) findViewById(R.id.words_mailmerge_executetemplate_arg4);
		function_arg3 = (Spinner) findViewById(R.id.words_mailmerge_executetemplate_arg3);
