...
import com.aspose.cloud.sdk.slides.DocumentProperty;

public class SlidesDocumentGetDocumentProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slides_document_getdocumentproperty);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							SlidesDocumentGetDocumentProperty.this);
					...
					if (response == null) {
						Toast.makeText(SlidesDocumentGetDocumentProperty.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.slides_document_getdocumentproperty_arg1);
