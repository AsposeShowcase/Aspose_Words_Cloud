...
public class CellsChartEditorGetBorder extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_charteditor_getborder);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsChartEditorGetBorder.this);
					...
					ChartEditor obj = new ChartEditor(constructor_arg1
							...
							.toString());
					try {
						response = obj.getBorder(chartIndex);
						if (response == null) {
							Toast.makeText(CellsChartEditorGetBorder.this,
									"Server Response Null", Toast.LENGTH_LONG)
									.show();
						} else {
							result.append("Border Style-"
									+ response.getStyle().toString());
						}
					} catch (Exception e) {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_charteditor_getborder_arg1);
