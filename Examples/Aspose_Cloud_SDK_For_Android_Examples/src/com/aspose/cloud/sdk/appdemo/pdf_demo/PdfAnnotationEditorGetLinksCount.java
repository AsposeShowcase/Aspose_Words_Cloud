...
public class PdfAnnotationEditorGetLinksCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_getlinkscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorGetLinksCount.this);
					...
					response = obj.getLinksCount(pageNumber);
					if (response > 0) {
						result.append("\n Number of Links = " + response);
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_annotationeditor_getlinkscount_arg1);
