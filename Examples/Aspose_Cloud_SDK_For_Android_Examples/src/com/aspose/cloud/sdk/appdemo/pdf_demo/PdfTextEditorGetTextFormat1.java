...
public class PdfTextEditorGetTextFormat1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_texteditor_gettextformat1);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfTextEditorGetTextFormat1.this);
					...
					if (response == null) {
						Toast.makeText(PdfTextEditorGetTextFormat1.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_texteditor_gettextformat1_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_texteditor_gettextformat1_arg2);
