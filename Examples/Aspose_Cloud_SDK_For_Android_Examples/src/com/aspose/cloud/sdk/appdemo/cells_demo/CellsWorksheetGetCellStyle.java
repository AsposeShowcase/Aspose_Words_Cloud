...
public class CellsWorksheetGetCellStyle extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcellstyle);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetCellStyle.this);
					...
					response = obj.getCellStyle(cellName);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetCellStyle.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Style Found in Specified Cell");
					} else {
						result.append("Style Name-" + response.getName());
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getcellstyle_arg1);
