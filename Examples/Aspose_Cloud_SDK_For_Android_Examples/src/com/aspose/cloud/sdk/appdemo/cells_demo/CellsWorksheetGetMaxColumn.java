...
public class CellsWorksheetGetMaxColumn extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getmaxcolumn);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetMaxColumn.this);
					...
					response = obj.getMaxColumn(offset, count);
					if (response > 0) {
						result.append("Number of Max Columns = " + response);
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getmaxcolumn_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_getmaxcolumn_arg2);
