...
public class WordDocumentDeleteProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_document_deleteproperty);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
						|| constructor_arg1.length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							WordDocumentDeleteProperty.this);
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.deleteProperty(propertyName);
					if (response) {
						result.append("Propery Deleted Successfully");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.words_document_deleteproperty_arg1);
