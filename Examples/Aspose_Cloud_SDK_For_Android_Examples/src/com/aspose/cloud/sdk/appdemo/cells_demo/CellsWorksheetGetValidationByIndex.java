...
public class CellsWorksheetGetValidationByIndex extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getvalidationbyindex);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetValidationByIndex.this);
					...
					response = obj.getValidationByIndex(index);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetValidationByIndex.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Validation Found");
					} else {
						result.append("\n Validation Title - "
								+ response.getInputTitle());
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getvalidationbyindex_arg1);
