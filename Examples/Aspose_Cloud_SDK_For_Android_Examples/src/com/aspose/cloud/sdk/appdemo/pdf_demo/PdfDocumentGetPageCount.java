...
public class PdfDocumentGetPageCount extends Activity {
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.getPageCount();
					if (response > 0) {
						result.append("Numbers Of Page = " + response);
					} else {
						result.append("No Page Found");
					}
				}
			}
		});
