...
public class CellsWorkbookDecrpytWorkbook extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_decryptworkbook);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookDecrpytWorkbook.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.decryptWorkbook(password);
					if (response) {
						result.append("Workbook is decrypted successfully.");
					} else {
	...
	private void init() {
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_decryptworkbook_arg1);
