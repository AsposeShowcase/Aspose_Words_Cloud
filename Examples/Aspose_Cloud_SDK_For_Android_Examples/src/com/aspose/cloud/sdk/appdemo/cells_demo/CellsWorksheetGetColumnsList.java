...
public class CellsWorksheetGetColumnsList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcolumnslist);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetColumnsList.this);
					...
					response = obj.getColumnsList(offset, count);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetColumnsList.this,
						...
						for (LinkResponse item : response) {
							result.append("Column Title - " + item.getTitle()
									+ " \n");
						}
					}
				}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getcolumnslist_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_getcolumnslist_arg2);
