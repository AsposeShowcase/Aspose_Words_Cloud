...
import com.aspose.cloud.sdk.cells.FillFormat;
import com.aspose.cloud.sdk.common.Product;
import com.aspose.cloud.sdk.common.AsposeApp;

public class CellsChartEditorGetFillFormat extends Activity {
	private EditText constructor_arg1, constructor_arg2;
	private EditText function_arg1;
	private TextView result;
	private Button btnSubmit;
	protected int chartIndex;
	protected FillFormat response;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_charteditor_getfillformat);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsChartEditorGetFillFormat.this);
					...
					ChartEditor obj = new ChartEditor(constructor_arg1
							...
							.toString());
					try {
						response = obj.getFillFormat(chartIndex);
						if (response == null) {
							Toast.makeText(CellsChartEditorGetFillFormat.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_charteditor_getfillformat_arg1);
