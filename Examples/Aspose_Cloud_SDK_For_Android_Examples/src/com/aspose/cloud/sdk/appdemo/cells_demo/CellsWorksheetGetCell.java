...
public class CellsWorksheetGetCell extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcell);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					response = obj.getCell(cellName);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetCell.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Value In This Cell");
					} else {
						result.append("Value of selected Cell = "
								+ response.getValue());
					}
				}
			}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getcell_arg1);
