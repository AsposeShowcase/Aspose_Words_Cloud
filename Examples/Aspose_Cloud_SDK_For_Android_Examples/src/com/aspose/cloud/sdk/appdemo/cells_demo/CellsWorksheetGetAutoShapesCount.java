...
public class CellsWorksheetGetAutoShapesCount extends Activity {
	private EditText constructor_arg1, constructor_arg2;
	private TextView result;
	private Button btnSubmit;
	protected int resposne;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getautoshapescount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetAutoShapesCount.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					Worksheet obj = new Worksheet("rubyTest.xlsx", "Sheet5");
					resposne = obj.getAutoShapesCount();
					if (resposne > 0) {
						result.append("Numbers of AutoShapes = " + resposne);
					} else {
						result.append("No AutoShape Found");
					}
				}
			}
		});
