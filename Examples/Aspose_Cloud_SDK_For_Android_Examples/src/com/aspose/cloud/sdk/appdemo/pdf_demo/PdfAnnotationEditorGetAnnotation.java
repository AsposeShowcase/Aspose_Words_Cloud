...
public class PdfAnnotationEditorGetAnnotation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_getannotation);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorGetAnnotation.this);
					...
					pageNumber = Integer.parseInt(function_arg1.getText()
							.toString());
					annotationIndex = Integer.parseInt(function_arg2.getText()
							.toString());
					AnnotationEditor obj = new AnnotationEditor("Reference.pdf");
					resposne = obj.getAnnotation(pageNumber, annotationIndex);
					if (resposne == null) {
						Toast.makeText(PdfAnnotationEditorGetAnnotation.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_annotationeditor_getannotation_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_annotationeditor_getannotation_arg2);
