...
public class CellsWorkbookCreateEmptyWorkbook extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_createemptyworkbook);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookCreateEmptyWorkbook.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.createEmptyWorkbook();
					if (response) {
						result.append("New Empty Worksheet is created in server");
					} else {
