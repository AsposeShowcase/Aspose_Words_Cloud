...
public class WordConverterConvert1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_converter_convert1);
		init();
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.words_converter_convert1_arg1);
