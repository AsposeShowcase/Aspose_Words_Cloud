...
public class CellsWorkbookGetProperties extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_getproperties);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookGetProperties.this);
					...
					if (response == null) {
						Toast.makeText(CellsWorkbookGetProperties.this,
