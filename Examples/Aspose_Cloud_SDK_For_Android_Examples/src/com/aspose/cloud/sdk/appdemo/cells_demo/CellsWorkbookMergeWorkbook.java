...
public class CellsWorkbookMergeWorkbook extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_mergeworkbook);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookMergeWorkbook.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					mergefileName = function_arg1.getText().toString();
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.mergeWorkbook(mergefileName);
					if (response) {
						result.append("Files are being merged");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_mergeworkbook_arg1);
