...
public class PdfAnnotationEditorIsChildBookmark extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_ischildbookmark);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorIsChildBookmark.this);
					...
					response = obj.isChildBookmark(bookmarkIndex);
					if (response) {
						result.append("This Bookmark Is a Child Bookmark");
					} else {
						result.append("This Bookmark is not a Child Bookmark");
					}
				}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_annotationeditor_ischildbookmark_arg1);
