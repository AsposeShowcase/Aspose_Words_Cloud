...
public class PdfTextEditorGetTextItems1 extends Activity {
	private EditText constructor_arg1;
	private TextView result;
	private Button btnSubmit;
	protected List<TextItem> resposne;
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfTextEditorGetTextItems1.this);
					...
					TextEditor obj = new TextEditor(constructor_arg1.getText()
							.toString());
					resposne = obj.getTextItems();
					if (resposne == null) {
						Toast.makeText(PdfTextEditorGetTextItems1.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Text Item Found");
					} else {
						result.append(" \n List : \n");
						for (TextItem item : resposne) {
