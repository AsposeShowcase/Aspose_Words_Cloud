...
public class CellsWorksheetUnhideWorksheet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_unhideworksheet);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetUnhideWorksheet.this);
					...
					response = obj.unhideWorksheet();
					if (response) {
						result.append("Worksheet is being Unhidden");
					} else {
