...
public class SlidesDocumentRemoveAllProperties extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slides_document_removeallproperties);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							SlidesDocumentRemoveAllProperties.this);
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					resposne = obj.removeAllProperties();
					if (resposne) {
