...
public class PdfDocumentDeletePage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_document_deletepage);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.deletePage(pageNumber);
					if (response) {
						result.append("Specified Page deleted from the document");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_document_deletepage_arg1);
