...
public class CellsWorksheetGetHyperLinkByIndex extends Activity {
	private EditText constructor_arg1, constructor_arg2;
	private EditText function_arg1;
	private TextView result;
	private Button btnSubmit;
	protected int index;
	protected Hyperlink response;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_gethyperlinkbyindex);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetHyperLinkByIndex.this);
					...
					response = obj.getHyperlinkByIndex(index);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetHyperLinkByIndex.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Hyper Link Found");
					} else {
						result.append("HyperLink - " + response.getAddress());
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_gethyperlinkbyindex_arg1);
