...
public class CellsWorksheetGetValidationsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getvalidationscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetValidationsCount.this);
					...
					response = obj.getValidationsCount();
					if (response > 0) {
						result.append("\n Number Of Validations = " + response);
					} else {
