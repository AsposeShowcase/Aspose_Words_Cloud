...
public class CellsChartEditorGetChartArea extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_charteditor_getchartarea);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsChartEditorGetChartArea.this);
					...
					ChartEditor obj = new ChartEditor(constructor_arg1
							.getText().toString(), constructor_arg2.getText()
							.toString());
					try {
						response = obj.getChartArea(chartIndex);
						if (response == null) {
							Toast.makeText(CellsChartEditorGetChartArea.this,
									"Server Response Null", Toast.LENGTH_LONG)
									.show();
						} else {
							result.append("Font Name-"
									+ response.getFont().getName());
						}
					} catch (Exception e) {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_charteditor_getchartarea_arg1);
