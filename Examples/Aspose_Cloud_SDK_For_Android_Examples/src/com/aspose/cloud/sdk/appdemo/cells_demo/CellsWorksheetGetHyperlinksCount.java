...
public class CellsWorksheetGetHyperlinksCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_gethyperlinkscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetHyperlinksCount.this);
					...
					response = obj.getHyperlinksCount();
					if (response > 0) {
						result.append("Number of HyperLinks = " + response);
					} else {
						result.append("No HyperLink Found");
					}
				}
			}
		});
