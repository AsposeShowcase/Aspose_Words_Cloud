...
public class PdfTextEditorGetTextItems2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_texteditor_gettextitems2);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfTextEditorGetTextItems2.this);
					...
					TextEditor obj = new TextEditor(constructor_arg1.getText()
							.toString());
					response = obj.getTextItems(pageNumber);
					if (response == null) {
						Toast.makeText(PdfTextEditorGetTextItems2.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_texteditor_gettextitems2_arg1);
