...
public class CellsWorkbookSetProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_setproperty);
		init();
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_setproperty_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_workbook_setproperty_arg2);
