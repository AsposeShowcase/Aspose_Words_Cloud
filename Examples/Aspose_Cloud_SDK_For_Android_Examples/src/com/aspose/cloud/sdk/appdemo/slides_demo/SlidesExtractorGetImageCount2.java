...
public class SlidesExtractorGetImageCount2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slides_extractor_getimagecount2);
		init();
			...
			public void onClick(View v) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							SlidesExtractorGetImageCount2.this);
					...
					Extractor obj = new Extractor(constructor_arg1.getText()
							.toString());
					response = obj.getImageCount(slideNumber);
					if (response > 0) {
						result.append("Number Of Images = " + response);
					} else {
						result.append("No Image Found");
					}
				}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.slides_extractor_getimagecount2_arg1);
