...
public class CellsWorkbookRemoveProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_removeproperty);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookRemoveProperty.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.removeProperty(propertyName);
					if (response) {
						result.append("Given Property is removed");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_removeproperty_arg1);
