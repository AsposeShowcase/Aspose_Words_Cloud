...
public class CellsWorksheetGetComment extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcomment);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					response = obj.getComment(cellName);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetComment.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Comment Found");
					} else {
						result.append("Comment - " + response.getNote());
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getcomment_arg1);
