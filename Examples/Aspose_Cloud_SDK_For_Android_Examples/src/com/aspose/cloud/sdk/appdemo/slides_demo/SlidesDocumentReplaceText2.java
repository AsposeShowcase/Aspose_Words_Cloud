...
public class SlidesDocumentReplaceText2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slides_document_replacetext2);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							SlidesDocumentReplaceText2.this);
					...
					slideNumber = Integer.parseInt(function_arg3.getText()
							.toString());
					Document obj = new Document(constructor_arg1.getText()
							.toString());
					response = obj.replaceText(oldText, newText, slideNumber);
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.slides_document_replacetext2_arg1);
		function_arg2 = (EditText) findViewById(R.id.slides_document_replacetext2_arg2);
		function_arg3 = (EditText) findViewById(R.id.slides_document_replacetext2_arg3);
