...
public class CellsTextEditorReplaceText2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_texteditor_replacetext2);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsTextEditorReplaceText2.this);
					...
					try {
						...
						if (response > 0) {
							result.append(response + " Matches Found");
						} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_texteditor_replacetext2_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_texteditor_replacetext2_arg2);
