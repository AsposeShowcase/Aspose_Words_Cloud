...
import com.aspose.cloud.sdk.pdf.Link;

public class PdfAnnotationEditorGetLink extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_getlink);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorGetLink.this);
					...
					response = obj.getLink(pageNumber, attachmentIndex);
					if (response == null) {
						Toast.makeText(PdfAnnotationEditorGetLink.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Link Found");
					} else {
						result.append("\n Link Action - "
								+ response.getAction());
					}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_annotationeditor_getlink_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_annotationeditor_getlink_arg2);
