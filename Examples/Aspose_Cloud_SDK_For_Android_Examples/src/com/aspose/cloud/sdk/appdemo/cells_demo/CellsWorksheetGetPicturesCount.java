...
public class CellsWorksheetGetPicturesCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getpicturescount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetPicturesCount.this);
					...
					response = obj.getPicturesCount();
					if (response > 0) {
						result.append("Number Of Pictures = " + response);
					} else {
