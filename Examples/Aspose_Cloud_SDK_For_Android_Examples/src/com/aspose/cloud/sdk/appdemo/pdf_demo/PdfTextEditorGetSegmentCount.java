...
public class PdfTextEditorGetSegmentCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_texteditor_getsegmentcount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfTextEditorGetSegmentCount.this);
					...
					fragmentNumber = Integer.parseInt(function_arg2.getText()
							.toString());
					TextEditor obj = new TextEditor("Reference.pdf");
					response = obj.getSegmentCount(pageNumber, fragmentNumber);
					if (response > 0) {
						result.append("Numbers Of Segment = " + response);
					} else {
						result.append("No Segment Found");
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_texteditor_getsegmentcount_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_texteditor_getsegmentcount_arg2);
