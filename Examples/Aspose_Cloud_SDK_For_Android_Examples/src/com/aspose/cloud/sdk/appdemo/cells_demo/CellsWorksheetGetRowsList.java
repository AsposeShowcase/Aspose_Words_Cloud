...
public class CellsWorksheetGetRowsList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getrowslist);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetRowsList.this);
					...
					response = obj.getRowsList(offset, count);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetRowsList.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Row List Found");
					} else {
						result.append(" \n List: \n");
						for (LinkResponse item : response) {
							result.append("Row Title - " + item.getTitle()
									+ "\n");
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getrowslist_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_getrowslist_arg2);
