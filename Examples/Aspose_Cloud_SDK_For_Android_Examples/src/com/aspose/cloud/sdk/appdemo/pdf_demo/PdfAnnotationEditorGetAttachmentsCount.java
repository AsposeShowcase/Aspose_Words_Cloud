...
public class PdfAnnotationEditorGetAttachmentsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_getattachmentscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorGetAttachmentsCount.this);
					...
					response = obj.getAttachmentsCount();
					if (response > 0) {
						result.append("No. OF Attachments = " + response);
					} else {
