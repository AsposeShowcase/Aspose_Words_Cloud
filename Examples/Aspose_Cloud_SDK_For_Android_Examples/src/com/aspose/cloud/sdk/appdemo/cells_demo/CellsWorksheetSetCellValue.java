...
public class CellsWorksheetSetCellValue extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_setcellvalue);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetSetCellValue.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					cellName = function_arg1.getText().toString();
					valueType = function_arg2.getText().toString();
					value = function_arg3.getText().toString();
					Worksheet obj = new Worksheet(constructor_arg1.getText()
							.toString(), constructor_arg2.getText().toString());
					response = obj.setCellValue(cellName, valueType, value);
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_setcellvalue_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_setcellvalue_arg2);
		function_arg3 = (EditText) findViewById(R.id.cells_worksheet_setcellvalue_arg3);
