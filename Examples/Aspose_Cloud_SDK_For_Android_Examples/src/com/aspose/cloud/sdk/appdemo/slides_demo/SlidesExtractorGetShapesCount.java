...
public class SlidesExtractorGetShapesCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slides_extractor_getshapescount);
		init();
			...
			public void onClick(View v) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							SlidesExtractorGetShapesCount.this);
					...
					Extractor obj = new Extractor(constructor_arg1.getText()
							.toString());
					response = obj.getShapesCount(slideNumber);
					if (response > 0) {
						result.append("Number of Shapes = " + response);
					} else {
						result.append("No Shape Found");
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.slides_extractor_getshapescount_arg1);
