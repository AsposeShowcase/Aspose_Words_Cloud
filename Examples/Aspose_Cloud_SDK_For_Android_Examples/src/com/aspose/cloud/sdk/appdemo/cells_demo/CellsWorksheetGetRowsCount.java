...
public class CellsWorksheetGetRowsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getrowscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetRowsCount.this);
					...
					response = obj.getRowsCount(offset, count);
					if (response > 0) {
						result.append("Number of Rows = " + response);
					} else {
						result.append("No row found");
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getrowscount_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_getrowscount_arg2);
