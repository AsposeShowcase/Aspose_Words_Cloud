...
public class OcrExtractorExtract5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ocr_extractor_extract5);
		init();
		...
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0) {
					...
					response = obj.extractText(imageFileName);
					if (response == null) {
						Toast.makeText(OcrExtractorExtract5.this,
	...
	private void init() {
		function_arg1 = (EditText) findViewById(R.id.ocr_extractor_extract5_arg1);
		result = (TextView) findViewById(R.id.ocr_extractor_extract5_result);
