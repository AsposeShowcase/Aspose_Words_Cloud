...
public class PdfDocumentRemoveAllProperties extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_document_removeallproperties);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfDocumentRemoveAllProperties.this);
					...
					try {
						...
						if (response) {
							result.append("All Properties has been removed");
						} else {
							result.append("Oops..Something went wrong");
						}
					} catch (SignatureException e) {
						// TODO Auto-generated catch block
						Toast.makeText(PdfDocumentRemoveAllProperties.this,
