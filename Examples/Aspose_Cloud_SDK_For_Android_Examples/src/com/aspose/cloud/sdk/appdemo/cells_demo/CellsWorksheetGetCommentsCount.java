...
public class CellsWorksheetGetCommentsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcommentscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetCommentsCount.this);
					...
					response = obj.getCommentsCount();
					if (response > 0) {
						result.append("Numbers Of Comments = " + response);
					} else {
