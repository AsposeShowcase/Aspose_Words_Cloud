...
public class WordConverterConvert2 extends Activity {
	...
	protected SaveFormat OutPutType;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_converter_convert2);
		init();
		function_arg2
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						// TODO Auto-generated method stub
						OutPutType = (SaveFormat) function_arg2
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(WordConverterConvert2.this,
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							WordConverterConvert2.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					output = function_arg1.getText().toString();
					Converter obj = new Converter(constructor_arg1.getText()
							.toString());
					response = obj.convert(output, OutPutType);
					if (response) {
						result.append("File Converted Successfully");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.words_converter_convert2_arg1);
		function_arg2 = (Spinner) findViewById(R.id.words_converter_convert2_arg2);
