...
public class CellsWorkbookProcessSmartMarker extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_processmartmarker);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookProcessSmartMarker.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					dataFile = function_arg1.getText().toString();
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.processSmartMarker(dataFile);
					if (response) {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_processsmartmarker_arg1);
