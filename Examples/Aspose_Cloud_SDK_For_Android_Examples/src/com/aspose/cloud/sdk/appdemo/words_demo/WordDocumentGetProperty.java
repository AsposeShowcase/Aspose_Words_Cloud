...
public class WordDocumentGetProperty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_document_getproperty);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					if (response == null) {
						Toast.makeText(WordDocumentGetProperty.this,
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.words_document_getproperty_arg1);
