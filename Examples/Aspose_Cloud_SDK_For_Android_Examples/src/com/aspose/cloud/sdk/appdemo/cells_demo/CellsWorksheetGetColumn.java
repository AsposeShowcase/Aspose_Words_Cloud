...
import com.aspose.cloud.sdk.cells.Column;
import com.aspose.cloud.sdk.cells.Worksheet;
import com.aspose.cloud.sdk.common.Product;
import com.aspose.cloud.sdk.common.AsposeApp;

public class CellsWorksheetGetColumn extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getcolumn);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetColumn.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					columnIndex = Integer.parseInt(function_arg1.getText()
							.toString());
					Worksheet obj = new Worksheet(constructor_arg1.getText()
							.toString(), constructor_arg2.getText().toString());
					response = obj.getColumn(columnIndex);
					if (response == null) {
						Toast.makeText(CellsWorksheetGetColumn.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Column Found");
					} else {
						result.append("Column Title - "
								+ response.getlink().getTitle());
					}
				}
			}
		});
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getcolumn_arg1);
