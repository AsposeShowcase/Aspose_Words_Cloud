...
public class CellsTextEditorFindText2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_texteditor_findtext2);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					text = function_arg2.getText().toString();
					TextEditor obj = new TextEditor(constructor_arg1.getText()
							.toString());
					try {
						response = obj.findText(WorkSheetName, text);
						if (response == null) {
							Toast.makeText(CellsTextEditorFindText2.this,
									"Server Response Null", Toast.LENGTH_LONG)
									.show();
							result.append("No Match Found");
						} else {
							result.append(String.valueOf(response.size())
									+ " Match Found. \n");
							result.append("List: \n");
						...
						Toast.makeText(
								CellsTextEditorFindText2.this,
								"Error Occured while perfoming this task. Please Try Again Later",
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_texteditor_findtext2_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_texteditor_findtext2_arg2);
