...
public class CellsWorksheetGetMergedCellByIndex extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getmergedcellbyindex);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetMergedCellByIndex.this);
					...
					respones = obj.getMergedCellByIndex(index);
					if (respones == null) {
						Toast.makeText(CellsWorksheetGetMergedCellByIndex.this,
								"Server Response Null", Toast.LENGTH_LONG)
								.show();
						result.append("No Merged Cell Found");
					} else {
						result.append(respones.getStartRow() + " - "
								+ respones.getEndRow());
					}
				}
			}
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getmergedcellbyindex_arg1);
