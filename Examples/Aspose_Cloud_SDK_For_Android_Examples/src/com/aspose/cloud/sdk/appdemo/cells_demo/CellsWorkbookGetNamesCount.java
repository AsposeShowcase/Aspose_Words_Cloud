...
public class CellsWorkbookGetNamesCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_getnamescount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0) {
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookGetNamesCount.this);
					...
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.getNamesCount();
					if (response > 0) {
						result.append("No Of Names: " + response);
					} else {
						result.append("No name found in this workbook");
					}
