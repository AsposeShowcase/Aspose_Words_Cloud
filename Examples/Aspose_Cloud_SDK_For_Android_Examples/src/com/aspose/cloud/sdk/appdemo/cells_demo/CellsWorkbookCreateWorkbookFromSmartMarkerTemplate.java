...
public class CellsWorkbookCreateWorkbookFromSmartMarkerTemplate extends
		Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_workbook_createworkbookfromsmartmarkertemplate);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorkbookCreateWorkbookFromSmartMarkerTemplate.this);
					...
					dataFile = function_arg2.getText().toString();
					Workbook obj = new Workbook(constructor_arg1.getText()
							.toString());
					response = obj.createWorkbookFromSmartMarkerTemplate(
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_workbook_createworkbookfromsmartmarkertemplate_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_workbook_createworkbookfromsmartmarkertemplate_arg2);
