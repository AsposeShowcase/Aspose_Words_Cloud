...
public class CellsWorksheetGetMaxRow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getmaxrow);
		init();
		btnSubmit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					response = obj.getMaxRow(offset, count);
					if (response > 0) {
						result.append("Numnber of Max Rows = " + response);
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_worksheet_getmaxrow_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_worksheet_getmaxrow_arg2);
