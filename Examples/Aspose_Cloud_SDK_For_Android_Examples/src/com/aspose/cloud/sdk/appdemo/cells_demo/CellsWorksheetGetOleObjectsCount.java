...
public class CellsWorksheetGetOleObjectsCount extends Activity {
	private EditText constructor_arg1, constructor_arg2;
	private TextView result;
	private Button btnSubmit;
	protected int respones;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getoleobjectscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetOleObjectsCount.this);
					...
					respones = obj.getOleObjectsCount();
					if (respones > 0) {
						result.append("Number Of Ole Objects = " + respones);
					} else {
