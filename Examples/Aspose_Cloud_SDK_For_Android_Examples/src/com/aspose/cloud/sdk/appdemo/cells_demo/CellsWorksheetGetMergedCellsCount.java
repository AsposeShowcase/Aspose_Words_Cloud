...
public class CellsWorksheetGetMergedCellsCount extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_worksheet_getmergedcellscount);
		init();
			...
			public void onClick(View arg0) {
				...
				if (constructor_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsWorksheetGetMergedCellsCount.this);
					...
					response = obj.getMergedCellsCount();
					if (response > 0) {
						result.append("Number of Merged Cells = " + response);
					} else {
